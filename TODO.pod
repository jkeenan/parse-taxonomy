...
=head2 Replace C<child_counts()> with C<descendant_counts()>.
...
Implement this, at first making the existing method names alias to the new
method names, then deprecated the older names in favor of the newer ones.
